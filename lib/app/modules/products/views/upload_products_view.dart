...
class _UploadProductsViewState extends State<UploadProductsView> {
  ...
  wTextField({required String keyboardType, required TextEditingController controller, required String labelText, required String hintText, required IconData prefixIcon}) {
